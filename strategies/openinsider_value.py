"""
OpenInsider Value strategy: Buy when any insider purchases >$500k.
"""
...
class OpenInsiderValueStrategy(BaseStrategy):

    def get_profiles(self) -> List[ProfileConfig]:
        return [ProfileConfig(
            profile_id='value_500k',
            display_name='Value >$500k',
            description='Buy when any insider purchases >$500k of their company stock',
            asset_type=AssetType.STOCK,
            data_source='openinsider',
            position_size_pct=12,
            max_positions=8,
            extra_params={'min_value': 500000},
        )]
    ...
    def generate_signals(self, profile, market_data, active_positions, portfolio_state) -> List[Signal]:
        ...
        min_value = profile.extra_params.get('min_value', 500000)
        ...
        for trade in market_data:
            ...
            signals.append(Signal(
                ...
                asset_type=AssetType.STOCK,
                confidence=0.7,
                reason=f"Large insider purchase ${value:,.0f}",
                metadata={
...
register_strategy(OpenInsiderValueStrategy())
